    ...
    return {
        ...
        holderCoordinates: {
            ...
            structure: {            // http://www.token.com.tw/chip-resistor/smd-resistor1.htm
               feedrate: 500,                               // slow feedrate in mm/min
            ...
            trays: {
                ...
                tray_1: { name: 'Tray Nr. 1',   width: 8, x: -106, y: 76 },
                tray_2: { name: 'Tray Nr. 2',   width: 8, x: -96,  y: 76 },
                tray_3: { name: 'Tray Nr. 3',   width: 8, x: -86,  y: 76 },
                tray_4: { name: 'Tray Nr. 4',   width: 8, x: -76,  y: 76 },
                tray_5: { name: 'Tray Nr. 5',   width: 8, x: -66,  y: 76 },
                tray_6: { name: 'Tray Nr. 6',   width: 8, x: -56,  y: 76 },
                tray_7: { name: 'Tray Nr. 7',   width: 8, x: -46,  y: 76 },
                tray_8: { name: 'Tray Nr. 8',   width: 8, x: -36,  y: 76 },
            },
            pockets: {
        ...
        onAddGcode : function(addGcodeCallback, gcodeParts, eagleWidget, helpDesc){
            ...
            chilipeppr.publish("/com-chilipeppr-elem-flashmsg/flashmsg", "Generate <b>Pick&Place</b> G-Code", "Rendering Pick and Place g-code moves.", 1 * 1000);
        ...
        */
        ...
        rotateStrategy: function(cmp){
            ...
            // $103=55.55 x microsteps ... rotate for 90° = 0.9, rotate for 180° = 1.8
        ...
        tapeStrategy: function(cmp, trayname){
            ...
            // set to absolute coordination system
            g += "G90" + "\n";
            g += "G0 Z" + this.safetyHeight + "\n";
