    ...
    return {
        ...
        holderCoordinates: {
            ...
            trays: {
                ...
                tray_1: { name: 'Tray Nr. 1',   width: 8, x: -106, y: 75 },
                tray_2: { name: 'Tray Nr. 2',   width: 8, x: -96,  y: 75 },
                tray_3: { name: 'Tray Nr. 3',   width: 8, x: -86,  y: 75 },
                tray_4: { name: 'Tray Nr. 4',   width: 8, x: -76,  y: 75 },
                tray_5: { name: 'Tray Nr. 5',   width: 8, x: -66,  y: 75 },
                tray_6: { name: 'Tray Nr. 6',   width: 8, x: -56,  y: 75 },
                tray_7: { name: 'Tray Nr. 7',   width: 8, x: -46,  y: 75 },
                tray_8: { name: 'Tray Nr. 8',   width: 8, x: -36,  y: 75 },
            },
            pockets: {
