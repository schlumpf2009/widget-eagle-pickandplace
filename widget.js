    ...
    return {
        ...
        holderCoordinates: {
            ...
            pockets: {
                ...
                Pocket_G: { name: 'Pocket G',   width: 15, x: 34,  y: 89 },
                Pocket_H: { name: 'Pocket H',   width: 15, x: 53,  y: 89 },
                Pocket_I: { name: 'Pocket I',   width: 15, x: 72,  y: 89 },
                Pocket_K: { name: 'Pocket K',   width: 15, x: 91,  y: 89 },
                Pocket_L: { name: 'Pocket L',   width: 15, x: 110, y: 89 },
                // ... etc.pp,
            },
        },
        ...
        drawTrays: function(){
            ...
            for (var trayname in this.holderCoordinates.trays) {
                var geometry = new THREE.BoxGeometry( this.holderCoordinates.trays[trayname].width  , this.holderCoordinates.size.dy, Math.abs( this.holderCoordinates.structure.tapeThick ) );
                var tape = new THREE.Mesh( geometry, material );
                tape.position.set( 
                    this.holderCoordinates.trays[trayname].x,
                    this.holderCoordinates.zero.y,
                    (this.holderCoordinates.structure.tapeThick/2)
                );
                trays.push(tape);
            }
        ...
        drawPlatform: function(){
            ...
            var geometry = new THREE.BoxGeometry( this.holderCoordinates.size.dx , this.holderCoordinates.size.dy, this.holderCoordinates.size.dz );
            ...
            platform.position.set( 
                ...
                this.holderCoordinates.zero.y, 
                (0 - (this.holderCoordinates.size.dz/2))-1
            );
            return platform;
        },
        /**
            ...
            var buildRow = function(elemValue){
               ...
               if($.type(data) == 'object')
                   tableRows.push([
                      ...
                      elemValue,
                      Object.keys(data).slice(0,-1).join(', '),
                      names.join(', '),
        ...
        */
            ...
            */
            ...
            for (var elemValue in this.components.forPockets ) {
               ...
               for (var cmpName in evalue ) {
                  ...
                  // get cmp from tray
                  g += this.pocketStrategy( evalue[cmpName], evalue['POCKET'] );
                  g += "G0 X" + evalue[cmpName].x + " Y" + evalue[cmpName].y + "\n";
                  g += this.putStrategy( evalue[cmpName] );
               }
            }
        ...
        putStrategy: function(cmp){
           ...
           // TODO: add rotate gcode for second controller
